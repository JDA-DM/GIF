...
- [GIFの考え方](#gifの考え方)
  - [目指す社会](#目指す社会)
  - [基本的な考え方](#基本的な考え方)
    - [従来の取り組みの継承](#従来の取り組みの継承)
    - [デジタル世界のルール形成](#デジタル世界のルール形成)
    - [参照モデルの活用](#参照モデルの活用)
    - [構造化したデータモデル](#構造化したデータモデル)
    - [グローバル連携](#グローバル連携)
  - [コンセプト](#コンセプト)
  - [GIFのアーキテクチャ](#gifのアーキテクチャ)
  - [GIFの推進ステップ](#gifの推進ステップ)
    - [見つけられること](#見つけられること)
    - [使えること](#使えること)
    - [自動処理できること](#自動処理できること)
    - [AI等で解析できること](#ai等で解析できること)
  - [GIFの役割と効果](#gifの役割と効果)
    - [相互運用性の向上（連携の容易さ）](#相互運用性の向上連携の容易さ)
    - [拡張性の向上](#拡張性の向上)
    - [設計コストや時間の削減](#設計コストや時間の削減)
    - [設計や運用の高度化](#設計や運用の高度化)
    - [ワンスオンリー、ワンストップの実現](#ワンスオンリーワンストップの実現)
  - [GIFの全体像](#gifの全体像)
  - [GIFが推進する参照モデルとは](#gifが推進する参照モデルとは)
- [戦略、組織人材、業務サービス層](#戦略組織人材業務サービス層)
- [ルール層](#ルール層)
    - [政府標準利用規約](#政府標準利用規約)
    - [個人情報保護条例](#個人情報保護条例)
    - [API利用規約](#api利用規約)
- [GIFのプラットフォーム層](#gifのプラットフォーム層)
  - [IDとアクセス管理](#idとアクセス管理)
  - [データカタログ](#データカタログ)
  - [コネクタ等による連携](#コネクタ等による連携)
    - [ブローカー](#ブローカー)
    - [コネクタ](#コネクタ)
  - [ツール](#ツール)
- [データ層](#データ層)
  ...
  - [各データモデル](#各データモデル)
    ...
    - [コード](#コード)
    - [ID（識別子）](#id識別子)
  - [データモデルの導入方法](#データモデルの導入方法)
  - [導入に関する注意点](#導入に関する注意点)
  - [既存データの扱い](#既存データの扱い)
- [アセット](#アセット)
- [セキュリティ、プライバシ・認証](#セキュリティプライバシ認証)
- [ドキュメント群](#ドキュメント群)
  - [実践ガイドブック](#実践ガイドブック)
  - [データモデル](#データモデル)
    - [コア語彙（共通語彙基盤［IPAで運用中］）](#コア語彙共通語彙基盤ipaで運用中)
    - [コアデータモデル](#コアデータモデル-1)
    - [コアデータパーツ（旧行政基本データ連携モデル）](#コアデータパーツ旧行政基本データ連携モデル)
  - [主要コード](#主要コード)
  - [実装データモデル](#実装データモデル-1)
    - [行政（行政サービス・データ連携モデル）](#行政行政サービスデータ連携モデル)
    - [スマートシティ](#スマートシティ)
- [研修](#研修)
  - [データ入門](#データ入門)
  - [データ整備](#データ整備)
  - [データ活用（スマートシティ編）](#データ活用スマートシティ編)
  - [ワンスオンリーサービスの作り方](#ワンスオンリーサービスの作り方)
- [今後の推進計画](#今後の推進計画)
...
2000年代後半にデジタルガバメントを見直しが行われ、サービスの基盤として相互運用性の必要性が着目されました。
そして、文字情報の整備から、その関連プロジェクトとしてデータモデルを中心とする共通語彙基盤（通称IMI）プロジェクトへと取り組みを拡大していき、データの基盤を整備する一方で、その活用を推進するため、2019年に、「デジタルファースト」「ワンスオンリー」「コネクテッド・ワンストップ」を３原則とするデジタル手続法[^1]　を制定しています。

また、日本の将来ビジョンであるSociety5.0の推進をする中でアーキテクチャの検討やデータ連携基盤の整備を進めてきました。
さらに、これらの取り組みを総括し、2021年6月に包括的データ戦略を策定し、2030年のデータ駆動社会の実現に向け取り組みを進めています。

本ガイドブックは、政府機関の持つサービスをスムースかつ効率的に連携できる相互運用可能な環境を実現することを目的にフレームワークの整備をしています。
詳細の技術項目は個別のガイドブック等で解説をします。
...
<img src="images/media/image2.emf" style="width:2.22778in;height:0.61102in" />
...
<img src="images/media/image3.emf" style="width:4.82222in;height:2.95038in" />
...
<img src="images/media/image4.emf" style="width:5.90556in;height:3.42847in" />
...
<img src="images/media/image5.emf" style="width:5.90556in;height:1.81389in" />
...
<img src="images/media/image6.emf" style="width:5.27325in;height:3in" />
...
<img src="images/media/image7.emf" style="width:4in;height:2.23707in" />
...
<img src="images/media/image8.emf" style="width:3.40556in;height:3.06944in" />
...
<img src="images/media/image9.emf" style="width:5.90556in;height:3.05278in" />
...
<img src="images/media/image10.emf" style="width:5.90556in;height:3.22569in" />

図 10　データモデルの利用イメージ

具体的に施設のコアデータモデルは、コア語彙の建物や施設のデータ項目を使い、実際の運用を想定したデータ項目に絞り込んでいます。それを元に、データ構造は同じまま学校データや避難所データの派生モデルを作っています。

<img src="images/media/image11.emf" style="width:4.05747in;height:2.40519in" />
