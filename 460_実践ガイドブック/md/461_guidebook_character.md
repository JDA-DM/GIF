...
- [2. 文字に関する標準的な取扱い](#2-文字に関する標準的な取扱い)
  ...
  - [2.2 各論](#22-各論)
    ...
    - [2.2.4 Webサイト、通知、掲示物における文字の取扱い](#224-Webサイト、通知、掲示物における文字の取扱い)
- [3. 文字環境導入のためのステップ](#3-文字環境導入のためのステップ)
  ...
  - [3.2 文字環境の導入の個別の流れ](#32-文字環境の導入の個別の流れ)
    ...
    - [3.2.4 データ連携、電子的な情報公開の有無の確認](#324-データ連携、電子的な情報公開の有無の確認)
    - [3.2.5 外字の必要性の判断](#325-外字の必要性の判断)

- [別紙　参考]
- [4. 文字](#4-文字)
  - [4.1 常用漢字](#41-常用漢字)
  - [4.2 文字情報基盤](#42-文字情報基盤)
  - [4.3 代替文字](#43-代替文字)
    - [4.3.1 氏名における代替文字](#431-氏名における代替文字)
    - [4.3.2 法人名における代替文字](#432-法人名における代替文字)
- [5. デジタル・ガバメント実行計画（抄）](#5-デジタル・ガバメント実行計画（抄）)
...
<figure>
<img src="md/461/media/image1.png" style="width:1.73819in;height:1.57014in" />
</figure>
...
<img src="md/461/media/image2.emf" style="width:2.55208in;height:1.65662in" />　
</figure>
...
<img src="md/461/media/image3.emf" style="width:2.57222in;height:1.66969in" />
</figure>
...
|外国人              |半角・アルファベット<br>（※） |全角・カタカナ  |全角・アルファベット                |
