...
| 改訂年月日    | 改訂箇所 | 改訂内容 |
|---------------|----------|----------|
| 2023年2月28日| 2.1.2.2 | 非識別加工情報について、改正個人情報保護法にあわせて行政機関等匿名加工情報に記載を変更、文言調整 |
| 2022年3月31日 |          | 初版決定 |
...
- [2. オープンデータの推進](#2-オープンデータの推進)
  - [2.1. オープンデータ化状況の定期調査](#21-オープンデータ化状況の定期調査)
    ...
    - [2.1.2. ＰＪＭＯの活動](#212-ｐｊｍｏの活動)
      ...
      - [2.1.2.3. 行政機関等匿名加工情報や法改正を検討](#2123-行政機関等匿名加工情報や法改正を検討)
...
自システムのデータがオープンデータの対象外とされている不適合要件に該当していないか、確認してください。以下に不適合要件の主な例を示します。
...
##### 2.1.2.3. 行政機関等匿名加工情報や法改正を検討

個人情報に関するデータは、当該保有個人情報の利用目的や利用目的以外の提供の根拠を確認してください。それによってオープンデータとすることが可能か検討が必要です。また、個人情報に関するデータを匿名加工した上で民間に提供する制度である行政機関等匿名加工情報を通じて、データの公開が可能な場合があります。必要に応じて検討してください。
