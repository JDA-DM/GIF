...
- [3. 　すべてのデータモデルへの共通事項](#3-すべてのデータモデルへの共通事項)
  ...
  - [3.3. 　日時](#33-日時)
    - [3.3.1. 定期スケジュール](#331-定期スケジュール)
        - [3.3.1.0.1. 年次スケジュール](#33101-年次スケジュール)
        - [3.3.1.0.2. 月次スケジュール](#33102-月次スケジュール)
        - [3.3.1.0.3. 週次スケジュール](#33103-週次スケジュール)
...
- [4. 　実装データモデル](#4-実装データモデル)
  - [4.1. 　土地](#41-土地)
    - [4.1.1. 土地](#411-土地)
        - [4.1.1.0.1. 参照元データ](#41101-参照元データ)
        - [4.1.1.0.2. データモデル](#41102-データモデル)
        - [4.1.1.0.3. データ項目に選択肢があるときの候補](#41103-データ項目に選択肢があるときの候補)
        - [4.1.1.0.4. 既存のデータモデル](#41104-既存のデータモデル)
    - [4.1.2. 都市計画基礎調査情報](#412-都市計画基礎調査情報)
  - [4.2. 　建物](#42-建物)
        - [4.2.0.0.1. 参照元データ](#42001-参照元データ)
        - [4.2.0.0.2. データモデル](#42002-データモデル)
        - [4.2.0.0.3. データ項目に選択肢があるときの候補](#42003-データ項目に選択肢があるときの候補)
        - [4.2.0.0.4. 既存データモデル](#42004-既存データモデル)
  - [4.3. 　施設](#43-施設)
    - [4.3.1. 基本形](#431-基本形)
        - [4.3.1.0.1. 参照元データ](#43101-参照元データ)
        - [4.3.1.0.2. データモデル](#43102-データモデル)
        - [4.3.1.0.3. データ項目に選択肢があるときの候補](#43103-データ項目に選択肢があるときの候補)
        - [4.3.1.0.4. 既存データモデル](#43104-既存データモデル)
    - [4.3.2. 公共施設・観光施設](#432-公共施設観光施設)
        - [4.3.2.0.1. 参照元データ](#43201-参照元データ)
        - [4.3.2.0.2. データモデル](#43202-データモデル)
        - [4.3.2.0.3. データ項目に選択肢があるときの候補](#43203-データ項目に選択肢があるときの候補)
        - [4.3.2.0.4. 既存データモデル](#43204-既存データモデル)
    - [4.3.3. 医療機関](#433-医療機関)
        - [4.3.3.0.1. 参照元データ](#43301-参照元データ)
        - [4.3.3.0.2. データモデル](#43302-データモデル)
        - [4.3.3.0.3. データ項目に選択肢があるときの候補](#43303-データ項目に選択肢があるときの候補)
        - [4.3.3.0.4. 既存データモデル](#43304-既存データモデル)
    - [4.3.4. 教育機関](#434-教育機関)
        - [4.3.4.0.1. 参照元データ](#43401-参照元データ)
        - [4.3.4.0.2. データモデル](#43402-データモデル)
        - [4.3.4.0.3. 既存のデータモデル](#43403-既存のデータモデル)
    - [4.3.5. 介護サービス事業所](#435-介護サービス事業所)
        - [4.3.5.0.1. 参照元データ](#43501-参照元データ)
        - [4.3.5.0.2. データモデル](#43502-データモデル)
        - [4.3.5.0.3. データ項目に選択肢があるときの候補](#43503-データ項目に選択肢があるときの候補)
        - [4.3.5.0.4. 既存のデータモデル](#43504-既存のデータモデル)
    - [4.3.6. 子育て支援施設](#436-子育て支援施設)
        - [4.3.6.0.1. 参照元データ](#43601-参照元データ)
        - [4.3.6.0.2. データモデル](#43602-データモデル)
        - [4.3.6.0.3. データ項目に選択肢があるときの候補](#43603-データ項目に選択肢があるときの候補)
    - [4.3.7. 事業所](#437-事業所)
        - [4.3.7.0.1. 参照元データ](#43701-参照元データ)
        - [4.3.7.0.2. データモデル](#43702-データモデル)
        - [4.3.7.0.3. データ項目に選択肢があるときの候補](#43703-データ項目に選択肢があるときの候補)
        - [4.3.7.0.4. 既存のデータモデル](#43704-既存のデータモデル)
    - [4.3.8. 食品等営業許可・届出事業所](#438-食品等営業許可届出事業所)
        - [4.3.8.0.1. 参照元データ](#43801-参照元データ)
        - [4.3.8.0.2. データモデル](#43802-データモデル)
        - [4.3.8.0.3. データ項目に選択肢があるときの候補](#43803-データ項目に選択肢があるときの候補)
    - [4.3.9. 公園](#439-公園)
        - [4.3.9.0.1. 参照元データ](#43901-参照元データ)
        - [4.3.9.0.2. データモデル](#43902-データモデル)
        - [4.3.9.0.3. データ項目内で選択肢があるときの候補](#43903-データ項目内で選択肢があるときの候補)
        - [4.3.9.0.4. 既存データモデル](#43904-既存データモデル)
    - [4.3.10. 交番](#4310-交番)
        - [4.3.10.0.1. 参照元データ](#431001-参照元データ)
        - [4.3.10.0.2. データモデル](#431002-データモデル)
    - [4.3.11. 入浴施設](#4311-入浴施設)
        - [4.3.11.0.1. 参照元データ](#431101-参照元データ)
        - [4.3.11.0.2. データモデル](#431102-データモデル)
    - [4.3.12. クリーニング施設（コインランドリー含む）](#4312-クリーニング施設コインランドリー含む)
        - [4.3.12.0.1. 参照元データ](#431201-参照元データ)
        - [4.3.12.0.2. データモデル](#431202-データモデル)
  - [4.4. 　設備](#44-設備)
    - [4.4.1. 基本形](#441-基本形)
        - [4.4.1.0.1. 参照元データ](#44101-参照元データ)
        - [4.4.1.0.2. データモデル](#44102-データモデル)
        - [4.4.1.0.3. データ項目内で選択肢があるときの候補](#44103-データ項目内で選択肢があるときの候補)
        - [4.4.1.0.4. 既存データモデル](#44104-既存データモデル)
    - [4.4.2. 出入口](#442-出入口)
        - [4.4.2.0.1. 参照元データ](#44201-参照元データ)
        - [4.4.2.0.2. データモデル](#44202-データモデル)
        - [4.4.2.0.3. 既存データモデル](#44203-既存データモデル)
    - [4.4.3. AED](#443-aed)
        - [4.4.3.0.1. 参照元データ](#44301-参照元データ)
        - [4.4.3.0.2. データモデル](#44302-データモデル)
    - [4.4.4. 公衆無線LANアクセスポイント](#444-公衆無線lanアクセスポイント)
        - [4.4.4.0.1. 参照元データ](#44401-参照元データ)
        - [4.4.4.0.2. データモデル](#44402-データモデル)
    - [4.4.5. 公衆トイレ](#445-公衆トイレ)
        - [4.4.5.0.1. 参照元データ](#44501-参照元データ)
        - [4.4.5.0.2. データモデル](#44502-データモデル)
        - [4.4.5.0.3. 既存データモデル](#44503-既存データモデル)
    - [4.4.6. 消防水利施設](#446-消防水利施設)
        - [4.4.6.0.1. 参照元データ](#44601-参照元データ)
        - [4.4.6.0.2. データモデル](#44602-データモデル)
        - [4.4.6.0.3. データ項目に選択肢があるときの候補](#44603-データ項目に選択肢があるときの候補)
  ...
  - [4.6. 　道路](#46-道路)
    - [4.6.1. 道路](#461-道路)
        - [4.6.1.0.1. 参照元データ](#46101-参照元データ)
        - [4.6.1.0.2. データモデル](#46102-データモデル)
        - [4.6.1.0.3. データ項目に選択肢があるときの候補](#46103-データ項目に選択肢があるときの候補)
        - [4.6.1.0.4. 既存データモデル](#46104-既存データモデル)
    - [4.6.2. 道路関連設備](#462-道路関連設備)
    - [4.6.3. 交通規制情報](#463-交通規制情報)
    - [4.6.4. 交通インフラ（橋、トンネル等）](#464-交通インフラ橋トンネル等)
  - [4.7. 交通関連施設](#47-交通関連施設)
    - [4.7.1. 空港](#471-空港)
        - [4.7.1.0.1. 参照元データ](#47101-参照元データ)
        - [4.7.1.0.2. データモデル](#47102-データモデル)
        - [4.7.1.0.3. データ項目に選択肢があるときの候補](#47103-データ項目に選択肢があるときの候補)
        - [4.7.1.0.4. 既存データモデル](#47104-既存データモデル)
    - [4.7.2. 港湾](#472-港湾)
        - [4.7.2.0.1. 参照元データ](#47201-参照元データ)
        - [4.7.2.0.2. データモデル](#47202-データモデル)
        - [4.7.2.0.3. 既存データモデル](#47203-既存データモデル)
    - [4.7.3. 駅・バス停](#473-駅バス停)
        - [4.7.3.0.1. 参照元データ](#47301-参照元データ)
        - [4.7.3.0.2. データモデル](#47302-データモデル)
        - [4.7.3.0.3. 既存データモデル](#47303-既存データモデル)
    - [4.7.4. 鉄道路線・バス路線](#474-鉄道路線バス路線)
        - [4.7.4.0.1. 参照元データ](#47401-参照元データ)
        - [4.7.4.0.2. データモデル](#47402-データモデル)
        - [4.7.4.0.3. データ項目に選択肢があるときの候補](#47403-データ項目に選択肢があるときの候補)
        - [4.7.4.0.4. 既存データモデル](#47404-既存データモデル)
    - [4.7.5. タクシー乗り場](#475-タクシー乗り場)
        - [4.7.5.0.1. 参照元データ](#47501-参照元データ)
        - [4.7.5.0.2. データモデル](#47502-データモデル)
        - [4.7.5.0.3. 既存データモデル](#47503-既存データモデル)
    - [4.7.6. 駐車場](#476-駐車場)
        - [4.7.6.0.1. 参照元データ](#47601-参照元データ)
        - [4.7.6.0.2. データモデル](#47602-データモデル)
        - [4.7.6.0.3. 既存データモデル](#47603-既存データモデル)
    - [4.7.7. 駐車スペース（路上）](#477-駐車スペース路上)
        - [4.7.7.0.1. 参照元データ](#47701-参照元データ)
        - [4.7.7.0.2. データモデル](#47702-データモデル)
        - [4.7.7.0.3. 既存データモデル](#47703-既存データモデル)
    - [4.7.8. 駐車スポット（荷さばき場所）](#478-駐車スポット荷さばき場所)
        - [4.7.8.0.1. 参照元データ](#47801-参照元データ)
        - [4.7.8.0.2. データモデル](#47802-データモデル)
        - [4.7.8.0.3. 既存データモデル](#47803-既存データモデル)
    - [4.7.9. 駐輪場](#479-駐輪場)
        - [4.7.9.0.1. 参照元データ](#47901-参照元データ)
        - [4.7.9.0.2. データモデル](#47902-データモデル)
    - [4.7.10. シェアードカーステーション](#4710-シェアードカーステーション)
    - [4.7.11. レンタル自転車・ｅスクータースポット](#4711-レンタル自転車ｅスクータースポット)
        - [4.7.11.0.1. 参照元データ](#471101-参照元データ)
        - [4.7.11.0.2. データモデル](#471102-データモデル)
        - [4.7.11.0.3. 既存データモデル](#471103-既存データモデル)
    - [4.7.12. ガソリンスタンド・水素ステーション](#4712-ガソリンスタンド水素ステーション)
        - [4.7.12.0.1. 参照元データ](#471201-参照元データ)
        - [4.7.12.0.2. データモデル](#471202-データモデル)
        - [4.7.12.0.3. 既存データモデル](#471203-既存データモデル)
    - [4.7.13. EVスタンド](#4713-evスタンド)
        - [4.7.13.0.1. 参照元データ](#471301-参照元データ)
        - [4.7.13.0.2. データモデル](#471302-データモデル)
        - [4.7.13.0.3. 既存データモデル](#471303-既存データモデル)
  - [4.8. 　地物・地点](#48-地物地点)
        - [4.8.0.0.1. 参照元データ](#48001-参照元データ)
        - [4.8.0.0.2. データモデル](#48002-データモデル)
        - [4.8.0.0.3. データ項目に選択肢があるときの候補](#48003-データ項目に選択肢があるときの候補)
        - [4.8.0.0.4. 既存データモデル](#48004-既存データモデル)
    - [4.8.1. 観光ポイント](#481-観光ポイント)
        - [4.8.1.0.1. 参照元データ](#48101-参照元データ)
        - [4.8.1.0.2. データモデル](#48102-データモデル)
        - [4.8.1.0.3. データ項目に選択肢があるときの候補](#48103-データ項目に選択肢があるときの候補)
        - [4.8.1.0.4. 既存データモデル](#48104-既存データモデル)
    - [4.8.2. 指定緊急避難場所](#482-指定緊急避難場所)
        - [4.8.2.0.1. 参照元データ](#48201-参照元データ)
        - [4.8.2.0.2. データモデル](#48202-データモデル)
    - [4.8.3. ゴミ集積場所](#483-ゴミ集積場所)
        - [4.8.3.0.1. 参照元データ](#48301-参照元データ)
        - [4.8.3.0.2. データモデル](#48302-データモデル)
    - [4.8.4. その他地点](#484-その他地点)
  - [4.9. 　移動オブジェクト](#49-移動オブジェクト)
    - [4.9.1. 基本形](#491-基本形)
        - [4.9.1.0.1. 参照元データ](#49101-参照元データ)
        - [4.9.1.0.2. データモデル](#49102-データモデル)
        - [4.9.1.0.3. データ項目に選択肢があるときの候補](#49103-データ項目に選択肢があるときの候補)
    - [4.9.2. 人](#492-人)
        - [4.9.2.0.1. 参照元データ](#49201-参照元データ)
        - [4.9.2.0.2. データモデル](#49202-データモデル)
        - [4.9.2.0.3. データ項目に選択肢があるときの候補](#49203-データ項目に選択肢があるときの候補)
        - [4.9.2.0.4. 既存データモデル](#49204-既存データモデル)
    - [4.9.3. 乗り物（自動車、オートバイ、自転車、船、飛行物、その他）](#493-乗り物自動車オートバイ自転車船飛行物その他)
        - [4.9.3.0.1. 参照元データ](#49301-参照元データ)
        - [4.9.3.0.2. データモデル](#49302-データモデル)
        - [4.9.3.0.3. データ項目に選択肢があるときの候補](#49303-データ項目に選択肢があるときの候補)
    - [4.9.4. 物](#494-物)
  - [4.10. 　自然](#410-自然)
    - [4.10.1. 植生](#4101-植生)
    - [4.10.2. 湖沼](#4102-湖沼)
    ...
    - [4.10.5. 天気](#4105-天気)
        - [4.10.5.0.1. データ項目に選択肢があるときの候補](#410501-データ項目に選択肢があるときの候補)
  - [4.11. 　農地](#411-農地)
        - [4.11.0.0.1. 参照元データ](#411001-参照元データ)
        - [4.11.0.0.2. データモデル](#411002-データモデル)
        - [4.11.0.0.3. データ項目に選択肢があるときの候補](#411003-データ項目に選択肢があるときの候補)
        - [4.11.0.0.4. 既存データモデル](#411004-既存データモデル)
  - [4.12. 　イベント・アクション](#412-イベントアクション)
    - [4.12.1. イベント](#4121-イベント)
        - [4.12.1.0.1. 参照元データ](#412101-参照元データ)
        - [4.12.1.0.2. データモデル](#412102-データモデル)
        - [4.12.1.0.3. データ項目に選択肢があるときの候補](#412103-データ項目に選択肢があるときの候補)
        - [4.12.1.0.4. 既存データモデル](#412104-既存データモデル)
    - [4.12.2. アクション](#4122-アクション)
        - [4.12.2.0.1. 参照元データ](#412201-参照元データ)
        - [4.12.2.0.2. データモデル](#412202-データモデル)
  - [4.13. 　緊急情報・防災情報](#413-緊急情報防災情報)
  - [4.14. 　行政情報](#414-行政情報)
    - [4.14.1. 行政情報](#4141-行政情報)
        - [4.14.1.0.1. 参照元データ](#414101-参照元データ)
        - [4.14.1.0.2. データモデル](#414102-データモデル)
        - [4.14.1.0.3. 既存データモデル](#414103-既存データモデル)
    - [4.14.2. 地域・年齢別人口](#4142-地域年齢別人口)
        - [4.14.2.0.1. 参照元データ](#414201-参照元データ)
        - [4.14.2.0.2. データモデル](#414202-データモデル)
  - [4.15. 　センサーデータ](#415-センサーデータ)
        - [4.15.0.0.1. 参照元データ](#415001-参照元データ)
        - [4.15.0.0.2. データモデル](#415002-データモデル)
        - [4.15.0.0.3. データ項目に選択肢があるときの候補](#415003-データ項目に選択肢があるときの候補)
        - [4.15.0.0.4. 既存データモデル](#415004-既存データモデル)
  - [4.16. 　健康情報](#416-健康情報)
    - [4.16.1. 健康情報](#4161-健康情報)
    - [4.16.2. 給食情報](#4162-給食情報)
        - [4.16.2.0.1. 参照元データ](#416201-参照元データ)
        - [4.16.2.0.2. データモデル](#416202-データモデル)
        - [4.16.2.0.3. データ項目に選択肢があるときの候補](#416203-データ項目に選択肢があるときの候補)
  - [4.17. 　文化財](#417-文化財)
    - [4.17.1. 建物、施設、もの、地物、地域の文化財](#4171-建物施設もの地物地域の文化財)
        - [4.17.1.0.1. 参照元データ](#417101-参照元データ)
        - [4.17.1.0.2. データモデル](#417102-データモデル)
        - [4.17.1.0.3. データ項目に選択肢があるときの候補](#417103-データ項目に選択肢があるときの候補)
        - [4.17.1.0.4. 既存データモデル](#417104-既存データモデル)
    - [4.17.2. 無形の文化財](#4172-無形の文化財)
        - [4.17.2.0.1. 参照元データ](#417201-参照元データ)
        - [4.17.2.0.2. データモデル](#417202-データモデル)
...
「文字」、「外国語表示・ピクトグラム」、「日時」、「緯度、経度」、「住所等」、「連絡先」、「画像」、「空間スキーマ」、「レコード情報」
...
「アクセシビリティ」、「子育て支援情報」、「言語対応」、「申込・予約」「支払」
...
####### 4.1.1.0.4.1. ３Ｄ都市モデル標準製品仕様書（国土交通省）
...
####### 4.1.1.0.4.3. 電子国土基本図　地図情報ファイル仕様書
...
####### 4.2.0.0.4.1. ３Ｄ都市モデル標準製品仕様書（国土交通省）
...
####### 4.3.1.0.4.1. ３Ｄ都市モデル標準製品仕様書（国土交通省）
...
####### 4.3.1.0.4.2. 電子国土基本図　地図情報ファイル仕様書
...
####### 4.3.2.0.4.2. ３Ｄ都市モデル標準製品仕様書（国土交通省）

urf:UrbanFacility、urf:DistrictFacilityの定義および派生形が参照できます。

####### 4.3.2.0.4.3. Smart Data Model

スマートシティ用のBuildingデータモデルの建物の基本情報に加え、BuildingOperationやBuildhingTypeのデータ項目を組み合わせて使用するモデルです。

####### 4.3.2.0.4.4. Schema.org
...
####### 4.3.3.0.4.1. 厚生労働省各地方局の「保険医療機関・保険薬局の指定等一覧」

厚生労働省各地方局が毎月公表する「保険医療機関・保険薬局の指定等一覧」が参照できます。

####### 4.3.3.0.4.2. 国土数値情報の「医療機関」

国土数値情報の医療情報[^31]が参照できます。

####### 4.3.3.0.4.3. ３Ｄ都市モデル標準製品仕様書（国土交通省）

urf:MedicalFacilityのデータ項目が参照できます。

####### 4.3.3.0.4.4. Schema.org
...
####### 4.3.5.0.4.1. ３Ｄ都市モデル標準製品仕様書（国土交通省）

urf:SocialWelfareFacilityのデータ項目が参照できます。

####### 4.3.5.0.4.2. Schema.org
...
###### 4.3.8.0.3. データ項目に選択肢があるときの候補 

####### 4.3.8.0.3.1. 食品衛生法施行令第35条
...
####### 4.4.1.0.4.1. ３Ｄ都市モデル標準製品仕様書

frn:CityFurnitureのデータモデルが参照できます。

####### 4.4.1.0.4.2. Schema.org
...
###### 4.4.6.0.3. データ項目に選択肢があるときの候補

####### 4.4.6.0.3.1. オープンデータの推奨データセット
...
###### 4.6.1.0.3. データ項目に選択肢があるときの候補

####### 4.6.1.0.3.1. 国土数値情報　緊急輸送道路　道路種別コード
...
####### 4.6.1.0.4.1. ３Ｄ都市モデル標準製品仕様書

Tran:roadのモデルが参照できます。車道、歩道など詳細な３Dモデルを作成できます。

####### 4.6.1.0.4.2. 電子国土基本図　地図情報ファイル仕様書

交通施設のサブパッケージのデータモデルを参照できます。

####### 4.6.1.0.4.3. Smart data model
...
####### 4.7.3.0.3.3. Smart data model

TransportStation、PublicTransportStopが参照できます。

####### 4.7.3.0.3.4. Schema.org
...
###### 4.7.4.0.3. データ項目に選択肢があるときの候補 

####### 4.7.4.0.3.1. GTFSの経路タイプ
...
####### 4.7.11.0.3.1. Smart data model

BikeHireDockingStationでサービス会社やサービスエリアのデータ項目を定義しています。

####### 4.7.11.0.3.2. GBFS（General Bikeshare Feed Specification）[^39]
...
###### 4.8.0.0.3. データ項目に選択肢があるときの候補

* POIは、GIFコード（POIコード）を参照します。

###### 4.8.0.0.4. 既存データモデル

####### 4.8.0.0.4.1. Smart Data Model

Point of Interestのデータ項目を参照できます。

####### 4.8.0.0.4.2. Schema.org
...
####### 4.9.2.0.4.1. 人の流れ（パーソントリップ）に関するデータモデル
...
####### 4.12.1.0.4.1. Smart data model

Eventのデータを定義しています。出演者などの詳細情報のデータ項目が参照できます。

####### 4.12.1.0.4.2. Schema.org
