...
|        |カテゴリー                    |Category           |物品役務、工事等のカテゴリーを記入。                                |                          |
|        |公示日                        |CFT_issue_date     |公示日を記入。YYYY-MM-DD                                            |                          |
|        |契約担当官                    |Official           |契約担当官名を記入                                                  |                          |
|        |調達機関コード                |Contract_folder_ID |調達機関番号を記入（国の機関の場合。その他の機関は法人番号を記入。）|                          |
|        |組織名                        |Organization_name  |調達組織名を記入                                                    |                          |
|        |機関種別名                    |Organization_type  |国または地方公共団体を記入                                          |                          |
|        |都道府県市町村コード          |Lg_code            |調達機関の所在地コードを記入                                        |                          |
|        |入札公告番号                  |CFT_ID             |入札公告に関する一意のIDを記入                                      |                          |
|        |号番号（上記IDと合わせて一意）|CFT_sub_ID         |入札公告番号に枝番があるときに記入                                  |物品・役務の調達時のみ使用|
|        |訂正・取消区分                |Revised_type       |変更や取消広告の時に記入                                            |物品・役務の調達時のみ使用|
|        |区分                          |Revised_sub_type   |変更や取消広告の時に記入                                            |物品・役務の調達時のみ使用|
|        |変更公示ID                    |Revised_CFT_ID     |公告に変更した時の関連公示のIDを記入                                |物品・役務の調達時のみ使用|
...
|          | 納入期限日                                   | Period_end_time                           | 納入期限を記入YYYY-MM-DD                                 | 物品・役務の調達時のみ使用 |
...
|          | 契約保証金                                   | Security_money_for_contract               | 契約保証金の額を記入                                     | 　                         |
...
|          |契約方式                      |Contract_type      |契約方式を記入                                                      |                          |
|          |落札者                        |Award_party        |落札者を記入                                                        |                          |
|          |落札者法人番号                |JCN                |法人番号を記入                                                      |                          |
|          |落札者氏名                    |Award_party_name   |落札者氏名を記入                                                    |                          |
|          |落札者住所                    |Award_party_address|落札者住所を記入                                                    |                          |
|          |落札価格                      |Award_price        |落札価格を記入                                                      |                          |
|          |随意契約理由                  |Award_discription  |随意契約理由を記入                                                  |                          |
|          |指名業者名                    |Candidate_name     |指名業者名を記入                                                    |                          |
|          |落札方式                      |Evaluation_type    |落札方式を記入                                                      |                          |
|          |予定価格                      |Estimate_price     |予定価格を記入                                                      |                          |
