...
- [1. はじめに](#1-はじめに）
  ...
  - [1.3 検討のプロセス](#13-検討のプロセス)
    - [1). 既存の標準群のデータ項目について対応表を作成](#131-既存の標準群のデータ項目について対応表を作成)
    - [2). 個々のデータ項目について必要性や定義を再検討](#132-個々のデータ項目について必要性や定義を再検討)
    - [3). 実装の容易さや利便性を加味して全体を構造化](#133-実装の容易さや利便性を加味して全体を構造化)
- [2. 全体像](#2-全体像)
  - [2.1 ドキュメントの構成](#21-ドキュメントの構造)
    - [1). コアデータモデル解説書](#211-コアデータモデル解説書)
    - [2). DMD(Data Model Description)](#212-DMD(Data Model Description))
    - [3). コアデータパーツ](#213-コアデータパーツ)
  - [2.2 コアデータモデルの全体構造](#22-コアデータモデルの全体構造)
  - [2.3 DMD (Data Model Description) の構造](#23-DMD (Data Model Description) の構造)
    - [1). 項目名、項目名（英語）](#231-項目名、項目名（英語）)
    - [2). 必須項目](#232-必須項目)
    - [3). 最小回数](#332-最小回数)
    - [4). 最大数](#334-最大数)
    - [5). 説明](#235-説明)
...
- [4. 全体に関わる留意事項](#4-全体に関わる留意事項)
  - [4.1 氏名、法人名の漢字表記の扱い](#41-氏名、法人名の漢字表記の扱い)
  - [4.2 氏名、法人名のヨミガナの扱い](#42-氏名、法人名のヨミガナの扱い)
  - [4.3 氏名、法人名、住所などのローマ字表記の扱い](#43-氏名、法人名、住所などのローマ字表記の扱い)
